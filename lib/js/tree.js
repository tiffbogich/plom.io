function sfr_tree() {
  var margin = {top: 20, right: 160, bottom: 20, left: 80},
  duration = 500;
    ...
    selection.each(function(data, j) {
      ...
      function update(source) {
        ...
        nodeEnter.append("text")
          ...
          .attr("dy", ".35em")
          .attr("class", function(d) {return "text-node-"+ d.type})
  ...
  "children": [
    {
      ...
      "children": [
        {
          "name": "Grenfell et al.(2000)",
          "type": "link",
          "privacy": "public",
          "children": [
            {"name": "Metcalf (2011)", "type": "link"},
            {"name": "Bogich et al. (2012)", "type": "link"}
          ]
        }
      ]
    },
    {
      "name": "Age structure (POLYMOD)",
      "type": "context",
      "children": [
        {
          "name": "Cazelles (in prep)",
          "type": "link",
          "children": [
            {"name": "Dureau (2012)",
             "type": "link",
             "children": [
               {"name": "Camacho (in prep)", "type": "link"}
             ]}]
        },
        {"name": "Pocheville (2010)", "type": "link"},
        {"name": "Aguilee (2011)", "type": "link"}
      ]
    },
    {
      "name": "SIR model",
      "type": "model",
      "children": [{"name": "Homogeneous mixing", "type": "context", "children":[
        {"name": "Arinaminpathy", "type": "link"}
      ]},
                   {
                     "name": "Vaccination",
                     "type": "intervention"
